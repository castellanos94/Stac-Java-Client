...
public class Main {
        public static void main(String[] args) {
                ...
                System.out.println("Kolmogorov-Smirnov: "
                                + StacConsumer.KOLMOGOROV(path, StacConsumer.SIGNIFICANCE_LEVEL[3]));
                ...
                System.out
                                .println("Friedman: " + StacConsumer.FRIEDMAN(path, StacConsumer.SIGNIFICANCE_LEVEL[3],
                                                POST_HOC.HOLM));
                System.out.println("Friedman Aligned Ranks: "
                                + StacConsumer.FRIEDMAN_ALIGNED_RANK(path, StacConsumer.SIGNIFICANCE_LEVEL[1],
                                                POST_HOC.HOCHBERG));
                System.out.println(
                                "QUADE-NEMENYI: " + StacConsumer.QUADE(path, StacConsumer.SIGNIFICANCE_LEVEL[0],
                                                POST_HOC.NEMENYI));
                System.out
                                .println("QUADE-HOLM: " + StacConsumer.QUADE(path, StacConsumer.SIGNIFICANCE_LEVEL[0],
                                                POST_HOC.HOLM));
                System.out.println(
                                "QUADE-FINNER: " + StacConsumer.QUADE(path, StacConsumer.SIGNIFICANCE_LEVEL[0],
                                                POST_HOC.FINNER));
                System.out.println(
                                "QUADE-HOCHBERG: " + StacConsumer.QUADE(path, StacConsumer.SIGNIFICANCE_LEVEL[0],
                                                POST_HOC.HOCHBERG));
                path = "src/main/resources/Toxina-Friedman-min3.csv";

                System.out.println("Mann-Whitney-U: " + StacConsumer.MANN_WHITNEY_U(path, "Cerebro", "Corazon", 0.05));
